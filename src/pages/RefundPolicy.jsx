    ...
    >
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-3xl font-black text-[#0a0a0a]">Refund & Cancellation Policy</h1>
        </div>
        ...
        <div className="space-y-10">
          ...
          <section>
            <h2 className="text-[#0a0a0a] font-bold text-lg mb-3 flex items-center gap-2">
              <span className="text-[#ed2024] font-black">1.</span> Refund Policy
            </h2>
            <ul className="space-y-2">
              {[
                'Advance payments are non-refundable',
                'Refunds (if applicable) depend on project stage',
              ].map((item) => (
          ...
          <section>
            <h2 className="text-[#0a0a0a] font-bold text-lg mb-3 flex items-center gap-2">
              <span className="text-[#ed2024] font-black">2.</span> Cancellation Policy
            </h2>
            <ul className="space-y-2">
              {[
                'Projects can be canceled with written notice',
                'Work completed until cancellation will be billed',
              ].map((item) => (
                <li key={item} className="flex items-start gap-2 text-sm text-gray-600">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#ed2024] mt-1.5 shrink-0" />
                  {item}
