        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto leading-relaxed">
              We don't design for aesthetics alone — we design for outcomes. Every layout and interaction is backed by user research and conversion data.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              { icon: Users, stat: '2x', statLabel: 'Retention', title: 'User-Centered Design', desc: 'Every design decision is rooted in real user research, personas, and behavior patterns.', color: 'text-blue-500', bg: 'bg-blue-100', border: 'border-blue-100' },
              { icon: Brain, stat: '98%', statLabel: 'Satisfaction', title: 'AI-Driven Insights', desc: 'AI analyzes user behavior patterns to guide design choices that convert and retain.', color: 'text-violet-500', bg: 'bg-violet-100', border: 'border-violet-100' },
              { icon: BarChart3, stat: '35%', statLabel: 'More Conversions', title: 'Data-Backed Decisions', desc: 'Every color, CTA, and layout choice is validated by analytics and A/B testing results.', color: 'text-emerald-500', bg: 'bg-emerald-100', border: 'border-emerald-100' },
              { icon: TrendingUp, stat: '∞', statLabel: 'Iterative', title: 'Conversion-Focused', desc: 'We design funnels that guide users from landing to conversion with minimal friction.', color: 'text-orange-500', bg: 'bg-orange-100', border: 'border-orange-100' },
            ].map((item, i) => (
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="flex flex-wrap justify-center gap-3">
            {['User-centered design principles', 'Data-backed design decisions', 'Conversion-focused strategies'].map((item) => (
