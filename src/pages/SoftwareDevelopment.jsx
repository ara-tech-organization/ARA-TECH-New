...
import { Brain, Code2, Server, Database, Cloud, Zap, CheckCircle2, BarChart3, Users, ArrowRight, Cpu, GitBranch, TestTube2, Rocket, TrendingUp, ShoppingCart, HeartPulse, GraduationCap, DollarSign, Building2, Sparkles } from 'lucide-react'
...
const whatWeBuild = [
  {
    icon: Database, wide: true,
    title: 'Business Software Solutions',
    desc: 'Custom-built systems to manage and optimize every aspect of your operations — from finance to HR.',
    points: ['ERP Systems', 'CRM Software', 'Inventory Management', 'HR & Payroll Systems'],
  },
  {
    icon: Cloud,
    title: 'SaaS Product Development',
    desc: 'Scalable SaaS platforms ready for global users.',
    points: ['Multi-tenant architecture', 'Subscription models', 'Secure cloud deployment'],
  },
  {
    icon: Server,
    title: 'Custom Web Applications',
    desc: 'Tailor-made web apps built for performance.',
    points: ['Booking Systems', 'Admin Dashboards', 'Customer Portals'],
  },
  {
    icon: Zap,
    title: 'Automation Software',
    desc: 'Automate repetitive business processes end-to-end.',
    points: ['Workflow automation', 'Data processing', 'Notifications & reporting'],
  },
  {
    icon: Brain,
    title: 'AI-Integrated Software',
    desc: 'Smart applications powered by Artificial Intelligence.',
    points: ['Chatbots', 'Predictive analytics', 'Smart recommendations'],
  },
]
...
const techStack = [
  ...
  { category: 'AI Tools & APIs', items: ['OpenAI', 'LangChain', 'TensorFlow'] },
  { category: 'Testing & DevOps', items: ['Jest', 'Cypress', 'Docker'] },
]

const process = [
  {
    icon: Users, title: 'Discovery',
    desc: 'Understand your business goals and requirements.',
    detail: 'We begin by diving deep into your business — understanding your goals, pain points, target users, and competitive landscape. This phase sets the foundation for everything that follows.',
    tags: ['Stakeholder Interviews', 'Requirement Analysis', 'Market Research'],
  },
  {
    icon: GitBranch, title: 'Planning',
    desc: 'Define architecture, features, and timelines.',
    detail: 'With a clear picture of what needs to be built, we map out a detailed technical roadmap — system architecture, database design, API structure, and sprint timelines.',
    tags: ['System Architecture', 'Sprint Planning', 'API Design'],
  },
  {
    icon: Code2, title: 'Development',
    desc: 'Build using modern technologies + AI tools.',
    detail: 'Our engineers build your product using the latest tech stack, with AI-assisted coding, automated code reviews, and daily progress updates to keep you in the loop.',
    tags: ['AI-Assisted Coding', 'Daily Updates', 'Agile Sprints'],
  },
  {
    icon: TestTube2, title: 'Testing',
    desc: 'Automated and manual QA for quality assurance.',
    detail: 'Before anything goes live, we run extensive automated and manual tests — covering performance, security, edge cases, and cross-device compatibility.',
    tags: ['Automated Testing', 'Security Audit', 'Performance Testing'],
  },
  {
    icon: Rocket, title: 'Deployment',
    desc: 'Fast and secure launch to production.',
    detail: 'We deploy your product using CI/CD pipelines for zero-downtime launches — with real-time monitoring, rollback safety, and full production readiness checks.',
    tags: ['CI/CD Pipeline', 'Zero Downtime', 'Live Monitoring'],
  },
  {
    icon: TrendingUp, title: 'Support & Scale',
    desc: 'Continuous updates, improvements, and automation.',
    detail: 'Post-launch, we stay by your side — fixing bugs, rolling out new features, optimizing performance, and scaling infrastructure as your user base grows.',
    tags: ['Bug Fixes', 'Feature Updates', 'Infrastructure Scaling'],
  },
]

const whyChoose = [
  'AI-First Development Approach',
  'Automation in Every Stage',
...
const industries = ['E-Commerce', 'Healthcare', 'Education', 'Finance', 'Real Estate', 'Startups', 'Enterprises']
  ...
  <div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#ed2024]/8 border border-[#ed2024]/20 text-[#ed2024] text-xs font-semibold mb-6 uppercase tracking-widest">
              <Code2 size={13} /> Software Development
            </motion.div>
            <motion.h1 variants={fadeUp} className="text-5xl md:text-6xl font-black text-[#0a0a0a] mb-6 leading-tight">
              Custom Software<br />Powered by<br /><span className="text-[#ed2024]">AI & Automation</span>
            </motion.h1>
            <motion.p variants={fadeUp} className="text-gray-500 text-xl leading-relaxed mb-8">
              We build scalable, secure, and intelligent software solutions tailored to your business — faster, smarter, and future-ready.
            </motion.p>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="space-y-4">
            <div className="rounded-3xl bg-white border border-black/8 p-7 shadow-xl overflow-hidden relative">
              ...
              <div className="space-y-3">
                {[
                  { label: 'High-performance applications', color: 'text-blue-400' },
                  { label: 'Automation-driven workflows', color: 'text-violet-400' },
                  { label: 'AI-integrated systems', color: 'text-emerald-400' },
                ].map((item) => (
            ...
            <div className="grid grid-cols-3 gap-3">
              {[['50%', 'Faster delivery'], ['99.9%', 'Uptime SLA'], ['3x', 'Efficiency gain']].map(([val, label]) => (
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            ...
            <p className="text-gray-500 text-lg max-w-md">From enterprise business systems to AI-powered SaaS platforms.</p>
          </div>
        </motion.div>
    ...
    <section className="bg-gray-50 py-24 px-6">
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-center mb-14">
          ...
          <p className="text-gray-500 text-base max-w-md mx-auto">Modern, scalable, and industry-standard technologies for every layer of your product.</p>
        </motion.div>
    ...
    <section className="bg-white py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Display panel — outer shell stays mounted (no remount = no progress reset) */}
        <div className="relative rounded-3xl overflow-hidden bg-white border border-black/6 min-h-[320px]">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-0 min-h-[320px]">
            ...
            <div className="p-10 lg:p-14 flex flex-col justify-between gap-8">
              ...
              {/* Detail content — animated independently */}
              <AnimatePresence mode="wait">
                <motion.div key={activeStep}
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            ...
            <p className="text-gray-500 text-lg max-w-sm">Not just a vendor. A growth partner that ships smarter.</p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[#0a0a0a] font-black text-3xl md:text-4xl leading-tight mb-3">AI-First.<br />Automation-Driven.</h3>
              <p className="text-gray-500 text-sm max-w-md">We bake AI and automation into every project — not as an add-on, but as the foundation.</p>
            </div>
            <div className="relative z-10 flex flex-wrap gap-2 mt-6">
              {['Faster Delivery', 'Lower Costs', 'Higher Accuracy'].map(tag => (
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1, duration: 0.5 }}
            ...
            <p className="relative z-10 text-gray-500 text-sm mt-4">Ship your product before the competition even starts.</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.15, duration: 0.5 }}
            ...
            <div className="text-5xl font-black text-emerald-200 leading-none select-none mb-4">$</div>
            <h3 className="text-[#0a0a0a] font-black text-xl mb-1">Cost-Effective</h3>
            <p className="text-gray-500 text-sm">Smarter builds mean fewer hours billed and better results.</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.5 }}
            ...
            <p className="text-gray-500 text-sm">Built to grow with your business — from MVP to millions of users.</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.25, duration: 0.5 }}
            ...
            <p className="text-gray-500 text-sm mb-5">A team that stays with you — after launch, after scale.</p>
            <div className="flex flex-wrap gap-2">
              {industries.map(ind => (
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Ready to Build Your Software?</h2>
            <p className="text-gray-400 text-lg max-w-lg mx-auto mb-8">Let's turn your idea into a powerful, intelligent system.</p>
