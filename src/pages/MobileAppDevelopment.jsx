        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto leading-relaxed">
              We embed AI and automation into every phase of mobile development to ship faster, reduce bugs, and deliver a better user experience.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              { icon: Brain, stat: '2x', statLabel: 'Speed', title: 'AI-Powered Features', desc: 'Smart recommendations, chatbots, and AI-driven personalization built right into your app.', color: 'text-blue-500', bg: 'bg-blue-100', border: 'border-blue-100' },
              { icon: Layers, stat: '1', statLabel: 'Codebase', title: 'Cross-Platform', desc: 'Flutter & React Native deliver native-feel apps on both iOS and Android from a single codebase.', color: 'text-violet-500', bg: 'bg-violet-100', border: 'border-violet-100' },
              { icon: Shield, stat: '100%', statLabel: 'Secure', title: 'Biometric & Encrypted', desc: 'End-to-end encryption and biometric authentication protect every user by default.', color: 'text-emerald-500', bg: 'bg-emerald-100', border: 'border-emerald-100' },
              { icon: TrendingUp, stat: '∞', statLabel: 'Growth', title: 'Analytics & Iteration', desc: 'Built-in analytics, A/B testing, and post-launch iteration keep your app improving.', color: 'text-orange-500', bg: 'bg-orange-100', border: 'border-orange-100' },
            ].map((item, i) => (
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="flex flex-wrap justify-center gap-3">
            {['AI-accelerated development', 'Cross-platform with native feel', 'Continuous post-launch improvement'].map((item) => (
