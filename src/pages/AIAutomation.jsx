          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-gray-500 text-lg leading-relaxed mb-8">
                While many companies are still adapting to AI, we already use it internally to speed up our development — and we build AI-powered systems that give our clients a real competitive edge.
              </p>
              <div className="space-y-3">
                {[
                  { label: 'AI used internally to speed up delivery', bg: 'bg-blue-50', icon: 'text-blue-500' },
                  { label: 'AI-powered systems built for clients', bg: 'bg-emerald-50', icon: 'text-emerald-500' },
                  { label: 'Automation across all business operations', bg: 'bg-violet-50', icon: 'text-violet-500' },
                ].map((item) => (
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }}>
              <div className="rounded-3xl bg-violet-50 border border-violet-100 p-8 overflow-hidden relative">
                ...
                <div className="relative z-10 space-y-4">
                  {[
                    { icon: Brain, label: 'AI used internally to speed up development', color: 'bg-blue-100 text-blue-500' },
                    { icon: Zap, label: 'AI-powered systems built for every client', color: 'bg-violet-100 text-violet-500' },
                    { icon: RefreshCw, label: 'Automated workflows across all operations', color: 'bg-emerald-100 text-emerald-500' },
                    { icon: TrendingUp, label: 'Competitive advantage in speed & efficiency', color: 'bg-orange-100 text-orange-400' },
                  ].map((item, i) => (
